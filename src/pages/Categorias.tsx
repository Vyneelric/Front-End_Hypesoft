        ...
        <Dialog>
          <DialogTrigger asChild>
            ...
            <DialogContent className="bg-white sm:max-w-xl">
              <DialogHeader>
                <DialogTitle className="font-bold mb-2">Nova Categoria</DialogTitle>
              </DialogHeader>
              <CategoriaForm />
            </DialogContent>
        </Dialog>
                ...
                <Table className="w-full table-fixed">
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="break-all whitespace-normal text-sm text-center">Produtos eletrônicos e tecnologia</TableCell>
                    </TableRow>
